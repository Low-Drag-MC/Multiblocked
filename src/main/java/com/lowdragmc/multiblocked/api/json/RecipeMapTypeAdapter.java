...
public class RecipeMapTypeAdapter implements JsonSerializer<RecipeMap>,
    ...
    public RecipeMap deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        ...
        recipeMap.fuelTexture = new ResourceTexture(GsonHelper.getAsString(json, "fuelTexture", recipeMap.fuelTexture.imageLocation.toString()));
        recipeMap.fuelThreshold = GsonHelper.getAsInt(json, "fuelThreshold", recipeMap.fuelThreshold);
