...
public class BlueprintTableWidget extends WidgetGroup {
    ...
    public BlueprintTableWidget(BlueprintTableTileEntity table) {
        ...
        this.addWidget(new ButtonWidget(40, 40, 40, 40, new ItemStackTexture(
                MbdItems.BUILDER), this::templateBuilder).setHoverBorderTexture(1, -1).setHoverTooltips("multiblocked.gui.blueprint_table.builder_template"));
        ...
        this.addWidget(new ButtonWidget(140, 90, 40, 40, new ResourceTexture("multiblocked:textures/gui/wiki.png"), this::openWikiPage).setHoverBorderTexture(1, -1).setHoverTooltips("multiblocked.gui.blueprint_table.wiki"));
    }
