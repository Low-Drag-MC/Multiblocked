...
public class PositionYCondition extends RecipeCondition {
    ...
    public ITextComponent getTooltips() {
        return new TranslationTextComponent("multiblocked.recipe.condition.pos_y.tooltip", this.min, this.max);
    }
    ...
    public RecipeCondition deserialize(@Nonnull JsonObject config) {
        ...
        min = JSONUtils.getAsInt(config, "min", Integer.MIN_VALUE);
        max = JSONUtils.getAsInt(config, "max", Integer.MAX_VALUE);
        return this;
    }
