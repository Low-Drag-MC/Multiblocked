package com.lowdragmc.multiblocked.core.core;
...
public class DynamicTileEntityGenerator implements Opcodes {
    ...
    private final String superConstructor;
    private final List<CapabilityTrait> traits;
    private final List<Class<?>> interfaces = new ArrayList<>();
    private final String name;

    public DynamicTileEntityGenerator(String name, List<CapabilityTrait> traits, Class<?> superClass) {
        this.name = name;
        this.traits = traits;
    ...
    private void constructor(ClassWriter classWriter, String className) {
        ...
        methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", superConstructor, null, null);
        methodVisitor.visitCode();
        Label label0 = new Label();
        methodVisitor.visitLabel(label0);
        methodVisitor.visitLineNumber(13, label0);
        methodVisitor.visitVarInsn(ALOAD, 0);
        methodVisitor.visitMethodInsn(INVOKESPECIAL, superClassName, "<init>", superConstructor, false);
