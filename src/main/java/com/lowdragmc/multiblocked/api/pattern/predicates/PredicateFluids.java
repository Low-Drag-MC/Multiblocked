...
public class PredicateFluids extends SimplePredicate {
    ...
    public List<WidgetGroup> getConfigWidget(List<WidgetGroup> groups) {
        ...
        }).setButtonTexture(new ResourceTexture("multiblocked:textures/gui/add.png")).setHoverBorderTexture(1, -1).setHoverTooltips("multiblocked.gui.predicate.fluids.add"));
        return groups;
    }
