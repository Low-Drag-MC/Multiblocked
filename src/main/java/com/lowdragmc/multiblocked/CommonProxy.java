...
public class CommonProxy {
    ...
    public static void registerComponents() {
        ...
        MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/mbd_energy_input"), PartDefinition.class, null);
        MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/mbd_energy_output"), PartDefinition.class, null);
        MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/mbd_item_input"), PartDefinition.class, null);
        MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/mbd_item_output"), PartDefinition.class, null);
        MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/mbd_fluid_input"), PartDefinition.class, null);
        MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/mbd_fluid_output"), PartDefinition.class, null);
        MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/mbd_entity"), PartDefinition.class, null);
        // register JsonFiles
        ...
        if (Multiblocked.isCreateLoaded()) {
            ...
            MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/create/mbd_create_input"), CreatePartDefinition.class, CreateBlockComponent::new, ItemComponent::new, null);
            MbdComponents.registerComponentFromResource(Multiblocked.class, new ResourceLocation(Multiblocked.MODID, "part/create/mbd_create_output"), CreatePartDefinition.class, CreateBlockComponent::new, ItemComponent::new, null);
